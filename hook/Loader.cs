...
namespace BD2ApostleDefense.Runtime
{
    public static class Loader
    {
        ...
        public static void Probe(){lock(typeof(Loader)){
            ...
            try{var probe=Activator.CreateInstance(typeof(Loader).Assembly.GetType("BD2ApostleDefense.Runtime.RuntimeEngine",true),true);probe.GetType().GetMethod("StartProbe",BindingFlags.NonPublic|BindingFlags.Instance).Invoke(probe,null);}
        ...
        public static void Load(){lock(typeof(Loader)){
            ...
            try{
                ...
                var prefixes=new[]{"BD2Fishing.Runtime","BD2Sichuan.Runtime","BD2Daily.Runtime","BD2ApostleDefense.Runtime","BD2InfiniteGacha.Runtime","BD2Rhythm.Runtime","BD2Territory.Runtime","BD2ArenaDefenseWatcher.Active.Runtime","BD2ReplayCaptureHook."};
                ...
                if(engine==null)engine=Activator.CreateInstance(own.GetType("BD2ApostleDefense.Runtime.RuntimeEngine",true),true);
        ...
        private static Assembly Resolve(object sender,ResolveEventArgs args){if(new AssemblyName(args.Name).Name!="0Harmony")return null;using(var s=typeof(Loader).Assembly.GetManifestResourceStream("BD2ApostleDefense.Harmony.dll"))using(var b=new MemoryStream()){s.CopyTo(b);return Assembly.Load(b.ToArray());}}
    }
}
