...
foreach($project in @('desktop/BD2ApostleDefense.Desktop.csproj','tests/BD2ApostleDefense.Tests.csproj','compatibility-tests/BD2ApostleDefense.Compatibility.Tests.csproj')){
